...
int main(int argc, char** argv) {
    ...
    mpca_lang(MPCA_LANG_DEFAULT,
            ...
            sexpr    : '(' <expr>* ')';                                        \
            qexpr    : '{' <expr>* '}';                                        \
            expr     : <double> | <number> | <symbol> | <string> | <sexpr> | <qexpr> ; \
            lispy    : /^/ <expr>* /$/ ;                                       \
            ",
            Number, Double, Symbol, String, Sexpr, Qexpr, Expr, Lispy);
    ...
    mpc_cleanup(8, Number, Double, Symbol, String, Sexpr, Qexpr, Expr, Lispy);
    return 0;
}
